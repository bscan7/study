...
//	}
//
//	//pFontWrapper->DrawString(pContext, L"D3D11 Hook by evolution536",
//	//	10.0f,// Font size
//	//	32.0f,// X position
//	//	32.0f,// Y position
...
//}
//
//void* __cdecl DetourFunc(PBYTE src, const PBYTE dest, const int length)
//{
//	PBYTE jump = (PBYTE)malloc(length + JMP_SIZE);
//
...
//
//	jump[0] = JMP;
//	*(PDWORD)(jump + 1) = (DWORD)(src + length - jump) - JMP_SIZE;
//
//	src[0] = JMP;
//	*(PDWORD)(src + 1) = (DWORD)(dest - src) - JMP_SIZE;
//
...
//	while (!dwD3D11)
//	{
//		dwD3D11 = (DWORD)GetModuleHandleA("dxgi.dll");
//		Sleep(250);
//	}
//
//	phookD3D11Present = (D3D11PresentHook)DetourFunc((PBYTE)(dwD3D11 + PRESENT_OFFSET), (PBYTE)hookD3D11Present, JMP_SIZE);
//
//	return 0;
//}
//
...
//#include <F:\\dev\\BeaEngine\\include\\BeaEngine.h>
//
////#pragma comment(lib, "F:\\dev\\BeaEngine\\lib\\BeaEngineCheetah64.lib")
//#pragma comment(lib, "F:\\dev\\BeaEngine\\lib\\BeaEngine64.lib")
//
//typedef HRESULT(__stdcall *D3D11PresentHook) (IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags);
...
//HRESULT __stdcall hookD3D11Present(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
//{
//	MessageBoxA(NULL, "calling hookD3D11Present!", "uBoos?", MB_ICONINFORMATION);
//	OutputDebugStringA("hookD3D11Present********************************************===");
//	if (firstTime)
//	{
//		pSwapChain->GetDevice(__uuidof(pDevice), (void**)&pDevice);
...
//{
//	MessageBoxA(NULL, "calling hookD3D11Present!", "uBoos?", MB_ICONINFORMATION);
//	OutputDebugStringA("hookD3D11DrawIndexed********************************************===");
...
//{
//	OutputDebugStringA("hookD3D11ClearRenderTargetView********************************************===");
//	MessageBoxA(NULL, "calling hookD3D11ClearRenderTargetView!", "uBoos?", MB_ICONINFORMATION);
...
//	HWND hWnd = FindWindowA("engine",NULL);
...
//#else
//
//	MessageBoxA(hWnd, "Wait for attach!", "uBoos?", MB_ICONINFORMATION);
//	Helpers::LogAddress("D3D11PRESENT", pSwapChainVtable[8]);
//	Helpers::LogAddress("D3D11DRAWINDEXED", pDeviceContextVTable[12]);
//	Helpers::LogAddress("D3D11CreateQuery", pDeviceContextVTable[24]);
//	Helpers::LogAddress("D3D11ClearRenderTargetView", pDeviceContextVTable[50]);
//
