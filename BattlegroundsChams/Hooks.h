...
typedef void(__stdcall *tD3D11UnMap)(ID3D11DeviceContext* pContext, _In_ ID3D11Resource *pResource, _In_ UINT Subresource/*, _In_ D3D11_MAP MapType, _In_ UINT MapFlags, _Out_ D3D11_MAPPED_SUBRESOURCE *pMappedResource*/);
...
namespace Hooks
{
	...
	void __stdcall hkD3D11UnMap(ID3D11DeviceContext* pContext, __in ID3D11Resource *pResource, __in UINT Subresource);
